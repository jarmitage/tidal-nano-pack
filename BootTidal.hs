...
-- Nano Pack start
tidal <- startStream (defaultConfig {cFrameTimespan = 1/240}) npOscMap

-- Nano Pack and SuperDirt combined
-- tidal <- startStream (defaultConfig {cFrameTimespan = 1/240}) npSDOscMap
